        ...
        Joker = {
            j_cry_CodeJoker = {
                ...
                text = {
                    ...
                    "创造一个随机{C:dark_edition}负片{}{C:cry_code}代码牌{}"
                }
            },
            ["j_cry_Double Scale"] = {
                name = "双重天平",
            ...
            j_cry_Scalae = {
                ...
                text = {
                    ...
                    "{C:inactive,s:0.8}({C:attention,s:0.8}平方成长、立方成长、四次方、五次方以此类推{C:inactive,s:0.8})",
