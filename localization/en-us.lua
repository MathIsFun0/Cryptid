return {
	...
	misc = {
		...
		dictionary = {
			...
			cry_mus_albuquerque = "Albuquerque (Albuquerque by \"Weird Al\" Yankovic - Copyrighted)",
			...
			cry_notif_albuquerque_1 = "Albuquerque",
			cry_notif_albuquerque_2 = "Copyright Notice",
			cry_notif_albuquerque_d1 = 'Albuquerque plays the song "Albuquerque",',
			cry_notif_albuquerque_d2 = "which is copyrighted and can't be",
			cry_notif_albuquerque_d3 = "used for streams and videos.",
